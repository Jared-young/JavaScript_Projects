...
function Input_Digit(digit) {
    ...
    //this checks if the wait second operand is true and sets display value
...
function Handle_Operator(Next_Operator) {
    ...
    //displayed on the screento a number and then store the results in
    ...
    //then updates the operator ad exits from the function.
...
//this function updates the calculator screen with the contents of Display Values
...
keys.addEventListener('click', (event) => {
    ...
    //that was clicked
    const { target } = event;
    //If the element was clocked on is not a button, exit function.
