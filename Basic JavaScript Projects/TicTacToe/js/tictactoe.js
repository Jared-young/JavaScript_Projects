// javaScript for Tic Tac Toe Project
...
function placeXOrO(squareNumber) {
    ...
    //The .some() method is used to check each element of the selectSquare arrayu
    //to see if it contains the square number clicked on.
    if (!selectedSquares.some(element => element.includes(squareNumber))) { //possible selectSquares instead of selectSquares
        ...
        if (activePlayer === 'X') {
            ...
            //If activePlayer is is equal to O, the o.png is placed in the HTML
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    //This line give us access to methods and propoerties to use on canvas
    ...
    let x1 = coordX1,
        ...
        y = y1;
    //this function interacts witht the canvas
    function animateLineDrawing() {
        ...
        c.stroke();
        //This condition checks if weve reached our endpoint
        if (x1 <= x2 && y1 <= y2) {
